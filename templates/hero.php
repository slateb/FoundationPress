...
<header id="homepage-hero" role="banner">
	<div class="row">
		...
		<div class="medium-6 columns end">
			<a role="button" class="download large button hide-for-small" href="https://github.com/olefredrik/starterslab">Download starterslab</a>
		</div>
	...
	<div class="row">
		...
		<?php while ( have_posts() ) : the_post(); ?>
			<article <?php post_class() ?> id="post-<?php the_ID(); ?>">
				...
				<footer>
					<?php wp_link_pages( array('before' => '<nav id="page-nav"><p>' . __( 'Pages:', 'starterslab' ), 'after' => '</p></nav>' ) ); ?>
					<p><?php the_tags(); ?></p>
				</footer>
				<?php do_action( 'starterslab_page_before_comments' ); ?>
				<?php comments_template(); ?>
				<?php do_action( 'starterslab_page_after_comments' ); ?>
			</article>
		<?php endwhile;?>
